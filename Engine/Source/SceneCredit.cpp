...
void SceneCredit::Init()
{
	...
	creditscrollsystem = coordinator.RegisterSystem<CreditScrollSystem>();
	...
	creditscrollsystem->Init();
}

void SceneCredit::EarlyUpdate(double dt)
{
...
void SceneCredit::Update(double dt)
{
	...
	creditscrollsystem->Update(dt);
}

void SceneCredit::LateUpdate(double dt)
{
