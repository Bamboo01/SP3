...
public:
	...
	virtual void UpdateUnitPosition(float dt);				// Update unit position
	virtual void UpdateEnemyGridCost(glm::vec3 Destination, std::vector<Entity>units, bool attacking, float dt);
	virtual void SetUp();
	virtual void Init();
